...
env = BattleEnvironment(show=False, hit_base_reward=10, hit_plane_reward=10, miss_punishment=-1, too_long_punishment=0, closer_to_base_reward=0, 
    closer_to_plane_reward=0, lose_punishment=-10)
